        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <Link to="/" className="inline-block mb-6">
               <img 
                    src="https://maximilianboy.de/mystaging02/wp-content/uploads/2025/10/cropped-cropped-cropped-cropped-cropped-cropped-659aa219-a326-43d5-b6bb-5b02d64a3c40_2-removebg-preview.png" 
                    alt="Maximilian Boy" 
