  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#0a0a0a] font-sans">
        ...
        .limax-hero-bg {
            ...
            z-index: 0;
            background-image: url("https://maximilianboy.de/mystaging02/wp-content/uploads/2025/01/20241123-limaex-ukongu-124.jpg");
            background-size: cover;
            background-position: center top;
            background-repeat: no-repeat;
            /* Weniger Blur für mehr Schärfe, etwas dunkler für Textlesbarkeit */
            filter: brightness(0.4); 
            pointer-events: none;
            transform: scale(1.05); /* Prevent white edges on scroll bounce */
        }
      ...
      {/* FIXED BACKGROUND */}
      <div className="limax-hero-bg"></div>
